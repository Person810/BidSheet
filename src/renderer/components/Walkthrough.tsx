...
/**
 * First-run guided tour. Spotlights each sidebar section in workflow
 * order with a short explanation. Mounted once in App; opens via the
 * walkthrough store (after setup, or replayed from Settings).
 */
